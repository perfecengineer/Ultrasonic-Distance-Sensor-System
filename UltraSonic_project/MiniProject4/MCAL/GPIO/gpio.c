...
void GPIO_setupPortDirection(uint8 port_num,uint8 value)
{
	if(!(port_num > 3))
	{
		switch(port_num)
		{
			case PORTA_ID:DDRA_ID_REG = value;break;
			case PORTB_ID:DDRB_ID_REG = value;break;
			case PORTC_ID:DDRC_ID_REG = value;break;
			case PORTD_ID:DDRD_ID_REG = value;break;
		}
	}
}
